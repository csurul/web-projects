...
app.get("/jokes/:id", (req, res) => {
  ...
  const foundJoke = jokes.find((object) => jokes.id === id);
...
app.get("/filter", (req, res) => {
  ...
  const foundJokes = jokes.filter((object) => jokes.type === type);
...
app.put("/jokes/:id", (req, res) => {
  ...
  const searchIndex = jokes.findIndex((object) => jokes.id === id);
...
app.delete("/jokes/:id", (req, res) => {
  ...
  if (searchIndex > -1) {
    ...
    res.status(404).json("no jokes found with that id");
  }

  jokes.at(searchIndex) = replacementJoke;
  console.log(jokes[searchIndex]);
  res.json(replacementJoke);
});
...
app.delete("/all", (req, res) => {
  const userKey = parseInt(req.query.key);
