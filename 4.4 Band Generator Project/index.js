...
app.post("/submit", (req, res) => {
  ...
  const adjSelected = adj[Math.floor(Math.random() * adj.length)];
  const nounSelected = noun[Math.floor(Math.random() * noun.length)];

  res.render("index.ejs", { adjective: adjSelected, noun: nounSelected });
  //Then:
